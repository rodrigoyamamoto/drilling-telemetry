...
internal sealed class RabbitMqSimulationSettingsConsumer
{
    ...
    private readonly SimulationSettingsCommandHandler _commandHandler;
    ...
    /// Handler used to apply received commands.
    /// </param>
    public RabbitMqSimulationSettingsConsumer(
        IChannel channel,
        string queueName,
        SimulationSettingsCommandHandler commandHandler)
    {
        ...
        BasicDeliverEventArgs eventArgs)
    {
        ...
        try
        {
            ...
            Console.WriteLine(
                $"Settings version {command.Version} applied: " +
